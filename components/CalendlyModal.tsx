        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-px bg-slate-100 overflow-y-auto max-h-[calc(90vh-100px)]">
          ...
          <div className="bg-white flex flex-col">
            <div className="px-6 py-4 border-b border-slate-100">
              <h3 className="font-semibold text-slate-900">Leopold de La Rochère</h3>
          ...
          <div className="bg-white flex flex-col">
            <div className="px-6 py-4 border-b border-slate-100">
              <h3 className="font-semibold text-slate-900">Thibaud</h3>
              <p className="text-xs text-slate-500">Serena</p>
            </div>
            <div className="flex-1 min-h-[500px]">
              <iframe
